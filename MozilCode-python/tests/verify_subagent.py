...
from mozilcode.agents.fork import FORK_BOILERPLATE_TAG, ForkError, build_forked_messages
...
def verify_notification():
    ...
    from mozilcode.agents.task_manager import BackgroundTask
...
def verify_agent_tool():
    ...
    from mozilcode.tools.agent_tool import AgentTool, AgentToolParams
