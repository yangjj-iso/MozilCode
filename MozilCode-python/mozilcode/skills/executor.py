...
from mozilcode.skills.parser import SkillDef, substitute_arguments
from mozilcode.tools import ToolRegistry

if TYPE_CHECKING:
    from mozilcode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from mozilcode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
