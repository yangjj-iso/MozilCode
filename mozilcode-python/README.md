...
`mozilcode-gui` package provides the local Vue/Tauri interface; it connects only
...
Set the same value as `VITE_MOZILCODE_DAEMON_TOKEN` when building or running the
