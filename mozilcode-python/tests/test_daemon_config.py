...
def test_route_registry_keeps_local_daemon_surface_only():
    assert [(spec.path, spec.methods) for spec in HTTP_ROUTES] == [
        ...
        ("/api/health", ("GET",)),
        ("/api/account", ("GET",)),
        ("/api/account/session", ("POST",)),
        ("/api/account/session", ("DELETE",)),
        ("/api/account/models", ("GET",)),
        ...
        ("/api/settings/mcp/{name}/toggle", ("POST",)),
        ("/api/settings/mcp/{name}", ("DELETE",)),
        ("/api/settings/memory", ("GET",)),
        ("/api/settings/memory", ("POST",)),
        ("/api/settings/qqbot", ("GET",)),
        ("/api/settings/qqbot", ("POST",)),
        ("/api/settings/telegrambot", ("GET",)),
        ("/api/settings/telegrambot", ("POST",)),
        ("/api/session", ("POST",)),
        ("/api/sessions", ("GET",)),
        ("/api/task", ("POST",)),
