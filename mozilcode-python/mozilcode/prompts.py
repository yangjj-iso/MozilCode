...
按 section + priority 组装 PromptBuilder，生成发给 LLM 的 system 文本。
"""
...
IDENTITY_SECTION = PromptSection(
    ...
    priority=0,
    content=(
        "You are MozilCode, an AI programming assistant running in the terminal. "
...
def build_system_prompt(
    ...
    if coordinator_mode:
        from mozilcode.teams.coordinator import get_coordinator_system_prompt
