...
from mozilcode.daemon.routes.account import (
...
HTTP_ROUTES: tuple[HttpRouteSpec, ...] = (
    ...
    HttpRouteSpec("/api/account", get_account, ("GET",)),
    HttpRouteSpec("/api/account/session", post_account_session, ("POST",)),
    HttpRouteSpec("/api/account/session", delete_account_session, ("DELETE",)),
    HttpRouteSpec("/api/account/models", get_account_models, ("GET",)),
    ...
    HttpRouteSpec("/api/session/{sid}/history", session_history, ("GET",)),
    HttpRouteSpec("/api/session/{sid}/mode", set_session_mode, ("POST",)),
    HttpRouteSpec("/api/session/{sid}/provider", set_session_provider, ("POST",)),
